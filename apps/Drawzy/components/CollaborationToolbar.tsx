    ...
    return (
        <div className="Start_Room_Session transition-transform duration-500 ease-in-out flex items-center justify-end gap-1 md:gap-2">
            ...
            <Button type="button" onClick={() => setIsOpen(true)}
                className={cn("Drawzy-button collab-button relative w-auto py-2 px-3 md:py-3 md:px-4 rounded-md text-[.875rem] font-semibold shadow-none active:scale-[.98]", inRoom ? "bg-[#0fb884] dark:bg-[#0fb884] hover:bg-[#0fb884]" : "bg-color-primary hover:bg-brand-hover active:bg-brand-active")}
