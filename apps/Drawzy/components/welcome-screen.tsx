        ...
        <>
            <div className="welcome-screen-center z-[3]">
                <div className="welcome-screen-center__logo collabyfont welcome-screen-decor">
                    <div className="DrawzyLogo is-small">
                        {/* <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="DrawzyLogo-icon">
                        ...
                        <h1 className="brand-title DrawzyLogo-text font-collabyfont">Drawzy</h1>
                    </div>
                </div>
