...
### 🔐 Privacy & End-to-End Encryption (E2EE) in Drawzy

Drawzy is built with **privacy by design** to ensure that no sensitive drawing data can be accessed by anyone other than the intended participants.
...
\`\`\`
https://Drawzy/#room=jsds6avshdva9,dsfds8bkj2432
\`\`\`

- \`jsds6avshdva9\`: Unique room ID (used by the server)  
- \`dsfds8bkj2432\`: Encryption key (used **only** on the client)
...
- Works like **Drawzy's E2EE rooms**, but tailored for your collaborative drawing logic
